...
class ResNetEncoder(RetinaNetEncoder):
    def __init__(self, block, layers):
        ...
        # we use only the bottleneck case
        self.fpn_sizes = [
...
def resnet50(num_classes, pretrained=False, **kwargs):
    ...
    if pretrained:
        encoder.load_state_dict(model_zoo.load_url('https://download.pytorch.org/models/resnet50-19c8e357.pth', model_dir='models'), strict=False)
